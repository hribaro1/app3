...
class App extends Component {
  ...
  render(props, state) {
    ...
    return html`
		<div class="container">
			<h1>${props.title}</h1>
			<div style="text-align: center; font-size:small;"> Hostname:
				<b> ${location.host}</b></div>
        <div style="text-align: center; font-size:small;"> Current network:
				<b> Test </b></div>
...
render(html`<${App} title="Bossplast Wifi Configurator" />`, document.body);
